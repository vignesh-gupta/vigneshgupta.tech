...
const UsesCard = ({ category, image, title, url }: UsesCardProps) => {
  return (
    ...
    >
      <ArrowUpRightIcon size={32} className="absolute right-6 top-6 hidden -translate-x-2 translate-y-2 text-muted opacity-0 transition duration-300 hover:rotate-[360deg] group-hover:translate-x-0 group-hover:translate-y-0 group-hover:opacity-100 dark:text-white md:inline-block" />
